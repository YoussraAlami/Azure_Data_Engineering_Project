...
spark = SparkSession.builder.appName('End to End processing').config(conf=conf).getOrCreate()
...
#i want to extract all the columns and then replace all the missing unstructured column names
...
fig.write_html('output/visa_number_in_japan_by_continent_2017.html')

#Top 10 countries not continent this time with the most issud visa in 2017
